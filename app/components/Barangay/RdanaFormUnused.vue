...
<template>
  <div class="py-3" id="rdana-form">
    ...
    <UCard :ui="{ body:  'sm:p-6'  }" class="page-break-avoid">
      <template #header>
...
<style scoped>
/* ✅ Applies only inside this RDANA form */
:deep(.u-input) {
  display: flex;
  align-items: center !important;
}

/* Adjust the actual <input> element inside Nuxt UI */
:deep(.u-input input) {
  padding-top: 0.6rem !important;     /* adds top margin inside */
...
/* Optional: make the border thinner for a lighter look */
:deep(.u-input) {
  border-width: 1px !important;
  border-color: #475569 !important;
}

/* Leave textareas as-is */
:deep(textarea) {
