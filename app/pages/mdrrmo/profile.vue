  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-5xl grid gap-6 lg:grid-cols-[1fr,1.05fr] items-start">
      <div class="rounded-3xl bg-gradient-to-br from-blue-600 via-slate-800 to-slate-900 text-white shadow-2xl p-8 md:p-10 space-y-6">
        <p class="text-sm uppercase tracking-[0.2em] text-blue-100">MDRRMO Profile</p>
        <div class="space-y-3">
          <h1 class="text-3xl font-semibold leading-tight">Stay reachable during incidents</h1>
          <p class="text-sm text-blue-50/80">
            Up-to-date contact details keep coordination clear when emergencies happen.
          </p>
        </div>
        ...
        <div class="space-y-4">
          <div class="flex gap-3">
            ...
            <div>
              <p class="font-semibold">Use your active email</p>
              <p class="text-sm text-blue-50/70">Alert notifications and report links will go here.</p>
            </div>
          </div>
          <div class="flex gap-3">
            ...
            <div>
              <p class="font-semibold">Confirm barangay coverage</p>
              <p class="text-sm text-blue-50/70">Set the barangay you coordinate with most for faster routing.</p>
            </div>
          </div>
          <div class="flex gap-3">
            ...
            <div>
              <p class="font-semibold">Save and continue</p>
              <p class="text-sm text-blue-50/70">Your changes apply right away and refresh dashboards.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <UCard class="shadow-xl rounded-2xl">
        <template #header>
          <div class="space-y-1">
            ...
            <p class="text-sm text-slate-500">Keep your name, email, and barangay assignment up to date.</p>
          </div>
        </template>
        ...
        <div class="space-y-4">
          ...
          <UForm :state="state" @submit="onSubmit" class="space-y-5">
            <div class="grid gap-4 sm:grid-cols-2">
              ...
              <UFormGroup label="Email" name="email" help="Use the address you monitor daily.">
            ...
            <UFormGroup label="Barangay" name="barangayId" help="Choose your primary barangay for coordination.">
              <USelect
